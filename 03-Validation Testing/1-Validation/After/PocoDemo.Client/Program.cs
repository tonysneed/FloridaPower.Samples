...
namespace PocoDemo.Client
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string address = string.Format("http://localhost{0}:51255/api/",
            ...
            {
                CustomerId = customerId, //"ABCDEF"
                OrderDate = DateTime.Today,
                //ShippedDate = DateTime.Today.AddDays(1),
                ShippedDate = DateTime.Today.Subtract(TimeSpan.FromDays(1)),
                //Freight = 1, //Range: 10-100
                Freight = -1,  //NonNegative
